...
function Homepage(){
	...
	function slideshow(){
	var imageUrls = ["1.jpg","3.png","4.png","5.png"]
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<p>MetisLinux is just another Linux distribution, made on top of Arch Linux.
        ...
        <div class="button"> Install </div>
							...
							<section id="second" class="main special" >
								...
								<ul class="statistics">
									...
									<li class="style4">
										<a href="https://www.youtube.com/@metislinuxme/archcraftos" target="_blank"><span class="icon  brands fa-youtube"></span>
					...
					<footer id="footer">
						...
						<section>
							...
							<ul class="icons">
								...
								<li><a href="issues" target="_blank" class="icon solid fa-bug alt"><span class="label">Issues</span></a></li>
								<li><a href="https://github.com/pwnwriter" target="_blank" class="icon solid fa-user alt"><span class="label">Adi1090x</span></a></li>
							</ul>
						</section>
						<p class="copyright">&copy; MetisLinux | <a href="https://github.com/pwnwriter" target="_blank">Nabeen Tiwaree</a></p>
					</footer>
